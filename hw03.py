...
def num_eights(x):
    ...
    """
    "*** YOUR CODE HERE ***"
    #ingredients x%10 ,x//10, num_eigths(x//10)
    if x == 0 :
        return 0
    elif x %10 == 8:
...
def count_coins(change):
    ...
    """
    "*** YOUR CODE HERE ***"
    def helper(change,small_coin):
        if  change==0: 
            return 1
        elif change< 0 or small_coin == None  :
            return 0
        else:
            return helper(change - small_coin,small_coin) +helper(change,get_next_coin(small_coin))
