class VendingMachine:
    ...
    """
    "*** YOUR CODE HERE ***"
    #'{0} is a number {1} is a string. '.format(a,b)
    ...
    def vend(self):
        if self.stock == 0 :
            ...
            #
        #if no stock return "Inventory empty..."
        #not enough money, add more funds
    ...
    def add_funds(self,money):
        ...
        #or shows there are no longer items
...
def store_digits(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    #lets iterate and reverse the number
    #get help
    """
    if n < 10 :
        return Link(n)
    else:
        return Link((n//(10 ** num_digits(n)) ,(store_digits(n % (10 ** num_digits(n) )))))
        """
    link= Link.empty
    while n>0:
        link=Link(n%10,link)
